// Java implementation of Binary Tree and Inorder Traversal
...
class BinaryTree {
    /*
        ...
        -------------------------------------------------------------
        Given a binary tree, perform an inorder traversal and store
        the result in a list. Inorder traversal visits nodes in the
        following order: Left -> Node -> Right.
    ...
    */
    public static void inorder(List<Integer> result, Node root) {
        if (root != null) {
