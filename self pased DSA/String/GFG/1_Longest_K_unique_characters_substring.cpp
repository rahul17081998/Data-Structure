...
and keep updaing our result. if unique elements exceed (that is unique_ele > k) then keep reming elements from
left side of the window untill quique elements in window becomes
*/
