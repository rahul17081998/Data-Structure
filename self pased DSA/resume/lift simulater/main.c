...
//
#define NLIFTS 3        /* the number of lifts in the buliding */
#define NFLOORS 15      /* the number of floors in the building */
#define NPEOPLE 15      /* the number of people in the building */
#define MAXNOINLIFT 6  /* maximum lift capacity */
//
